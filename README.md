...
### Currently using this custom Account Number generator util [Generator.java](./VPD Account System/src/main/java/com/ikem/vpda_ccount_system/util/Generator.java) to generate account numbers for new accounts. Will add ability to use last 10 digits of a user phone number, soon.
